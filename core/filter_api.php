	...
	if( !is_blank( $t_filter[FILTER_PROPERTY_SEARCH] ) ) {
		...
		foreach( $t_search_terms as $t_search_term => $t_negate ) {
			...
			$t_textsearch_where_clause .= '( ' . db_helper_like( '{bug}.summary' ) .
				...
				' OR ' . db_helper_like( '{bugnote_text}.call_date' ) .
				' OR ' . db_helper_like( '{bugnote_text}.call_time' ) .
				' OR ' . db_helper_like( '{bugnote_text}.call_type' ) .
				' OR ' . db_helper_like( '{bugnote_text}.tel_no' ) .
