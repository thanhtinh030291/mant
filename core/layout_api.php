...
function layout_navbar() {
	...
	echo '<a href="' . $t_short_path . $t_logo_url . '" class="navbar-brand" style="display: inline-flex;">';
	echo '<img height="25px" src="images/logo_blue_cross-trans.png" />';
...
function layout_footer() {
	...
	echo '<address>' . "\n";
	echo '<strong>Powered by <a href="https://www.pacificcross.com.vn" title="bug tracking software">Pacific Cross Vietnam</a></strong> <br>' . "\n";
	echo "<small>Copyright &copy;$t_copyright_years Pacific Cross Vietnam</small>" . '<br>';
	...
	if( !is_page_name( 'login_page' ) ) {
		...
		$t_mantisbt_logo_url = helper_mantis_url( 'images/logo_blue_cross-trans.png' );
		echo '<a href="https://www.pacificcross.com.vn" '.
			'title="Pacific Cross Vietnam">' .
			'<img src="' . $t_mantisbt_logo_url . '" width="102" height="35" ' .
			'alt="Powered by Pacific Cross Vietnam." />' .
			'</a>' . "\n";
		echo '</div>' . "\n";
		echo '</div>' . "\n";
	}
